...
@SpringBootTest
@WebAppConfiguration
public class AksesiApplicationTestParametrized {
    ...
    public AksesiApplicationTestParametrized(List<PasswordElementDTO> elements, String expected) {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {Arrays.asList(new CharacterElementDTO('a')), "a"},
                {Arrays.asList(new GestureElementDTO(Arrays.asList(
                        new PointDTO(1L, 1L), new PointDTO(2L, 2L)
                ))), "LineDIAGONAL_RIGHT"},
                {Arrays.asList(new CharacterElementDTO('a'), new GestureElementDTO(Arrays.asList(
                        new PointDTO(1L, 1L), new PointDTO(2L, 2L)
                ))), "aLineDIAGONAL_RIGHT"}
        });
    }
