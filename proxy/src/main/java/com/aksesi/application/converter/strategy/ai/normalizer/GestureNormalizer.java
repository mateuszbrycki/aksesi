package com.aksesi.application.converter.strategy.ai.normalizer;
...
public class GestureNormalizer implements IGestureNormalizer {
    ...
    public GestureNormalizer(@Autowired IGesturePointsAligner pointsAligner,
                             @Autowired IFormattedInputSupplier formattedInputSupplier,
                             @Autowired IGestureResizer gestureResizer) {
    ...
    public double[] normalize(List<Gesture.Point> pointsList) {
    ...
    private double[] convertToArray(List<Gesture.Point> points) {
