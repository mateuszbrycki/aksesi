...
import com.aksesi.generator.shape.LineDiagonalLeftGenerator;

/**
 * Created by Mateusz Brycki on 21/05/2017.
 */
public class LineDiagonalLeftGeneratorTestable extends LineDiagonalLeftGenerator {
    public LineDiagonalLeftGeneratorTestable(Configuration configuration) {
        super(configuration);
    }
