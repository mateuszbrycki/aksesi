...
import com.aksesi.generator.shape.LineVerticalGenerator;

/**
 * Created by Mateusz Brycki on 21/05/2017.
 */
public class LineVerticalGeneratorTestable extends LineVerticalGenerator {

        public LineVerticalGeneratorTestable(Configuration configuration) {
            super(configuration);
        }
